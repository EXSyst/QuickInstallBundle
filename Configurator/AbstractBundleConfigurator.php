...
abstract class AbstractBundleConfigurator implements ConfiguratorInterface
{
    ...
    private function getConfigFile(Bundle $bundle, SymfonyStyle $io)
    {
        if (null === $this->configFile) {
            ...
            $io->block('Warning: any formatting in the config file generated by the library will be lost. Ensure that the file you choose doesn\'t contain important comments. The file path is relative to your kernel path. Only Yaml is supported for now.', null, 'comment');

            $result = $io->ask('In which file do you want to save your config?', $default);
